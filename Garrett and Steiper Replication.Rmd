...
There is a very big long list of PGLS comparisons that Garrett and Steiper did, and I don't really feel up for doing it (Seriously, the list is two pages long!). Therefore, I'm only going to do the PGLS tests that showed significance both before and after the Bonferroni correction. I have pasted the table of all the tests they did below, highlighting the ones that I will do. 
